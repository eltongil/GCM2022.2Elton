...
import br.ufrn.imd.banco.View.Deposito.DepositoTab;
import br.ufrn.imd.banco.View.Saldo.SaldoTab;
import br.ufrn.imd.banco.View.Saque.SaqueTab;
...
public class PainelDeAbas {
    ...
    private static TabPane setPainel(){
        ...
        painel.getTabs().add(DepositoTab.getInstance());
        painel.getTabs().add(SaqueTab.getInstance());
        return painel;
    }
